...
public class UserService implements UserDetailsService {
    ...
    public ResponseEntity<UserListDto> create(UserRequestDto userRequestDto) {
        ...
        user.setSubscriptionId(subscriptionRepository.findBySubsId(userRequestDto.getSubscriptionId()).orElseThrow(() -> new UsernameNotFoundException("Subscription not found")));

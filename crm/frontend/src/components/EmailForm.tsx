...
const EmailForm: React.FC<EmailFormProps> = ({
  ...
  return (
    ...
    >
      <Form.Item
        name="provider"
        label="Email Sağlayıcısı"
        rules={[
          { required: true, message: 'Lütfen email sağlayıcısı seçin!' },
        ]}
      >
        <Select placeholder="Email sağlayıcısı seçin">
      ...
      <Form.Item
        ...
        rules={[
          { required: true, message: 'Lütfen gönderen email adresini girin!' },
          { type: 'email', message: 'Geçerli bir email adresi girin!' },
        ]}
      >
        <Input placeholder="Gönderen email adresini girin" />
      </Form.Item>
